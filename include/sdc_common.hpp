...
void sdc_create_clock_set_waveform(Callback& callback, const VHdc_Lexer& lexer, CreateClock& sdc_create_clock, double rise_time, double fall_time);
...
//set_false_path
void sdc_set_false_path_add_to_from_group(Callback& callback, const VHdc_Lexer& lexer, SetFalsePath& sdc_set_false_path, StringGroup group, FromToType to_from_dir);
void add_sdc_set_false_path(Callback& callback, const VHdc_Lexer& lexer, SetFalsePath& sdc_set_false_path);

//set_max_delay
void sdc_set_min_max_delay_set_type(Callback& callback, const VHdc_Lexer& lexer, SetMinMaxDelay& sdc_set_max_delay, MinMaxType type);
void sdc_set_min_max_delay_set_value(Callback& callback, const VHdc_Lexer& lexer, SetMinMaxDelay& sdc_set_max_delay, double max_delay);
void sdc_set_min_max_delay_add_to_from_group(Callback& callback, const VHdc_Lexer& lexer, SetMinMaxDelay& sdc_set_max_delay, StringGroup group, FromToType to_from_dir);
void add_sdc_set_min_max_delay(Callback& callback, const VHdc_Lexer& lexer, SetMinMaxDelay& sdc_set_max_delay);
...
void sdc_set_multicycle_path_add_to_from_group(Callback& callback, const VHdc_Lexer& lexer, SetMulticyclePath& sdc_set_multicycle_path, StringGroup group, FromToType to_from_dir);
...
void sdc_set_clock_uncertainty_add_to_from_group(Callback& callback, const VHdc_Lexer& lexer, SetClockUncertainty& sdc_set_clock_uncertainty, StringGroup group, FromToType to_from_dir);
...
void sdc_set_clock_latency_set_clocks(Callback& callback, const VHdc_Lexer& lexer, SetClockLatency& sdc_set_clock_latency, StringGroup clock_targets);
void add_sdc_set_clock_latency(Callback& callback, const VHdc_Lexer& lexer, SetClockLatency& sdc_set_clock_latency);

//set_disable_timing
void sdc_set_disable_timing_add_to_from_group(Callback& callback, const VHdc_Lexer& lexer, SetDisableTiming& sdc_set_disable_timing, StringGroup group, FromToType to_from_dir);
...
void add_sdc_set_timing_derate(Callback& callback, const VHdc_Lexer& lexer, SetTimingDerate& sdc_set_multicycle_path);
